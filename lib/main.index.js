...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    value: function gotoNextLevel() {
      ...
      _classPrivateFieldSet(this, _level, this.nextLevel);
    ...
    key: "maximalCoefficient",
    get: function get() {
      return _classPrivateFieldGet(this, _maximalCoefficient);
    }
    /**
...
var Cell = /*#__PURE__*/function () {
  ...
  _createClass(Cell, [{
    ...
    value: function uncover() {
      _classPrivateFieldSet(this, _covered, false);
...
/* harmony import */ var _Cell_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Cell.js */ "./src/Grid/Cell.js");
...
var Grid = /*#__PURE__*/function () {
  ...
  _createClass(Grid, [{
    ...
    value: function _generateGrid() {
      ...
      for (var i = 0; i < _classPrivateFieldGet(this, _mines); ++i) {
        grid.push(new _Cell_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
          mine: true
        }));
      }
      ...
      for (var _i = 0; _i < this._nbNormalCells; ++_i) {
        normalCoeffs.push(1);
      }
      ...
      grid.push.apply(grid, _toConsumableArray(normalCoeffs.map(function (value) {
        return new _Cell_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
          value
        });
      })));
    ...
    key: "getGroupIndications",
    value: function getGroupIndications(group) {
...
var Memo = /*#__PURE__*/function () {
  ...
  _createClass(Memo, [{
    ...
    key: "empty",
    get: function get() {
      return _classPrivateFieldGet(this, _set).size === 0;
    }
  }]);
